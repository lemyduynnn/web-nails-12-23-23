...
declare const getIconCollections: (include: CollectionNames[]) => Record<string, IconifyJSON>;
...
export { CollectionNames, IconsPluginOptions, dynamicIconsPlugin, getIconCollections, iconsPlugin };
