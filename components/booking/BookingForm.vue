        ...
        <div class="flex flex-col gap-6 pt-10">
          ...
          >
            <div v-if="index === 0" class="bg-[#F5F5F5] flex flex-col w-full">
              <div
                v-for="(item, index) in block.listService"
                :key="index"
                    ...
                    <div class="flex justify-between items-center">
                      ...
                      <div class="flex gap-4 items-center justify-center">
                        ...
                        <div>
                          <UCheckbox
                            class="text-main"
                            @change="handleCheckboxChange(index, key)"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div class="lg:mt-20">
            ...
            >
              ...
              <div
                class="grid lg:grid-cols-2 grid-cols-1 justify-between items-center gap-4 p-6"
              >
                <div
                  v-for="(item, index) in staffChecked"
                  :key="index"
              ...
              <!-- <div class="flex flex-col gap-6 border-b border-black pb-10">
                <div
                  class="bg-white rounded-3xl p-4 flex justify-between items-center lg:w-1/2 w-full"
                >
                ...
                <div class="flex flex-col gap-4 rounded-3xl">
                  ...
                  <div class="font-sans text-xs">
                    1 or 2 Rows moved up; Full Service Includes a relaxing
                    shampoo, scalp treatment, extension restoration treatment,
                    blow dry, and styled finish.
                  </div>
                </div>
              </div> -->
              <div
