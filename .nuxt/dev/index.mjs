...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "baseURL": "/_ipx",
    "fs": {
      "dir": "/Users/lethimyduyen/Documents/intern/web-emily/public"
    },
    "http": {
      "domains": []
    }
...
const serverAssets = [{"baseName":"server","dir":"/Users/lethimyduyen/Documents/intern/web-emily/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/lethimyduyen/Documents/intern/web-emily/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/lethimyduyen/Documents/intern/web-emily/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/lethimyduyen/Documents/intern/web-emily","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/lethimyduyen/Documents/intern/web-emily/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/lethimyduyen/Documents/intern/web-emily/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/lethimyduyen/Documents/intern/web-emily/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/lethimyduyen/Documents/intern/web-emily/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _chPr2fL3JP = (function(nitro) {
...
const parseMarkdown = async (md, opts = {}) => {
  if (!moduleOptions) {
    moduleOptions = await import(
      'file:///Users/lethimyduyen/Documents/intern/web-emily/.nuxt/mdc-imports.mjs'
      /* @vite-ignore */
    ).catch(() => ({}));
  }
...
const _zXDiIu = defineEventHandler(async (event) => {
...
const _Hxq2HO = defineEventHandler(async (event) => {
...
const _4SI0F3 = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _nFk1mt = lazyEventHandler(() => {
...
const _lazy_J4dMfi = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _Hxq2HO, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _4SI0F3, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _4SI0F3, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _4SI0F3, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _nFk1mt, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_J4dMfi, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/lethimyduyen/Documents/intern/web-emily/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/lethimyduyen/Documents/intern/web-emily/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
